...
public class Conexion {
    ...
    private String user= "root"; //por defecto siempre que se decarga el xamp se trae el usuario root
    private String password= "";
    private String urlConexion = "jdbc:mysql://localhost:3306/reto1_xm"; //direccion de conexion al proyecto    
